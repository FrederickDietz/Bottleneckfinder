pretty basic. just put a python program in the same area as the bottleneck finder named "test.py" and launch. you're done; it will print off / guess your bottlenecks.
